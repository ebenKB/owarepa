      ...
      <div className={`${styles.content_text} sm:w-full md:w-4/5 xl:w-4/5`}>
        <ItemListWrapper>
          <li className="pb-8">
            ...
            <p className="faint-caption content_text">A bond of friendship is formed between players and spectators alike.</p>
          </li>
          <li className="pb-8">
            <h3 className="text-3xl">Acadamically, Oware improves one's counting ability</h3>
            <p className="faint-caption content_text">At various levels of the game, users ponder over best possible moves that can make them win.</p>
          </li>
          <li className="pb-8">
            <h3 className="text-3xl">It is a memory booster</h3>
            <p className="faint-caption content_text">
